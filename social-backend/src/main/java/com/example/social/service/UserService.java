...
public class UserService {
    ...
    private final ImagesRepository imagesService;
    ...
    public void deleteUser(String id) {
        commentReposity.deleteByUser(userRepository.findOneById(id));
        favorietRepository.deleteByUserid(id);
        storyRepository.deleteByUserid(id);
        followingRepository.deleteByUserIdOrFollowId(id, id);
        imagesService.deleteByUserid(id);
